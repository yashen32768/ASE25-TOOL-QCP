...
#[export] Instance MonoPred_mL (A: Type) {R1: KI.Relation A} {po_R1: PreOrder KI.Krelation} {R2: KM.Relation A} {uR2: UpwardsClosedOrderedKripkeModel A} : ModalLanguage (MonoPred_L A) :=
  Build_ModalLanguage (MonoPred_L A) SemanticsMono.boxp.

#[export] Instance MonoPred_fmSM (A: Type) {R1: KI.Relation A} {po_R1: PreOrder KI.Krelation} {R2: KM.Relation A} {uR2: UpwardsClosedOrderedKripkeModel A} : @FlatModalSemantics (MonoPred_L A) (MonoPred_minL A) (MonoPred_mL A) (Build_Model A) (unit_kMD _) tt R1 R2 (MonoPred_SM A).
Proof.
  constructor.
  intros; apply Same_set_refl.
Qed.

#[export] Instance MonoPred_KmGamma (A: Type) {R1: KI.Relation A} {po_R1: PreOrder KI.Krelation} {R2: KM.Relation A} {uR2: UpwardsClosedOrderedKripkeModel A}: SystemK (MonoPred_L A) (MonoPred_Gamma A).
Proof.
  constructor.
  + intros x y.
...
#[export] Instance MonoPred_pmGamma (A: Type) {R1: KI.Relation A} {po_R1: PreOrder KI.Krelation} {R2: KM.Relation A} {uR2: UpwardsClosedOrderedKripkeModel A} {pf_R2: PartialFunctional KM.Krelation}: PropositionalTransparentModality (MonoPred_L A) (MonoPred_Gamma A).
Proof.
  constructor.
  intros x y.

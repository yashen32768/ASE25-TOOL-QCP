...
#[export] Instance Functional_PartialFunctional {A: Type} {R: relation A} {_: Functional R}: PartialFunctional R.
Proof.
  intros; hnf; intros.
...
#[export] Instance Functional_Serial {A: Type} {R: relation A} {_: Functional R}: Serial R.
Proof.
  intros; hnf; intros.

...
#[export] Instance eq_preorder (A: Type): PreOrder (@eq A) :=
  Build_PreOrder _ (eq_Reflexive) (eq_Transitive).

#[export] Instance RelProd_Preorder:
...
#[export] Instance RelProd_PartialFunctional:
  forall {A B : Type} (RA: relation A) (RB : relation B),
...
#[export] Instance RelProd_Bisimulation:
...
#[export] Instance RelProd_Inclusion:
...
#[export] Instance pointwise_preorder:
...
#[export] Instance option00_reflexive {A: Type} (R: relation A) {_: Reflexive R}: Reflexive (option00_relation R).
Proof.
  hnf; intros.
  destruct x.
...
#[export] Instance option01_reflexive {A: Type} (R: relation A) {_: Reflexive R}: Reflexive (option01_relation R).
Proof.
  hnf; intros.
  destruct x.
  + constructor; reflexivity.
...
#[export] Instance option00_symmetric {A: Type} (R: relation A) {_: Symmetric R}: Symmetric (option00_relation R).
Proof.
  hnf; intros.
  inversion H0; subst.
  + constructor.
...
#[export] Instance option00_transitive {A: Type} (R: relation A) {_: Transitive R}: Transitive (option00_relation R).
Proof.
  hnf; intros.
  hnf; intros.
...
#[export] Instance option01_transitive {A: Type} (R: relation A) {_: Transitive R}: Transitive (option01_relation R).
Proof.
  hnf; intros.
  hnf; intros.
  inversion H0; inversion H1; subst; try first [congruence | constructor].
...
#[export] Instance option00_preorder {A: Type} (R: relation A) {_: PreOrder R}: PreOrder (option00_relation R)
  := Build_PreOrder _ (option00_reflexive R) (option00_transitive R).

#[export] Instance option01_preorder {A: Type} (R: relation A) {_: PreOrder R}: PreOrder (option01_relation R)
  := Build_PreOrder _ (option01_reflexive R) (option01_transitive R).

#[export] Instance option00_equiv {A: Type} (R: relation A) {_: Equivalence R}: Equivalence (option00_relation R)
...
#[export] Instance sum00_reflexive {A B: Type} (RA: relation A) (RB: relation B) {_: Reflexive RA} {_: Reflexive RB}: Reflexive (sum00_relation RA RB).
Proof.
  hnf; intros.
  destruct x; constructor; auto.
Qed.

#[export] Instance sum01_reflexive {A B: Type} (RA: relation A) (RB: relation B) {_: Reflexive RA} {_: Reflexive RB}: Reflexive (sum01_relation RA RB).
Proof.
  hnf; intros.
  destruct x; constructor; auto.
Qed.

#[export] Instance sum00_transitive {A B: Type} (RA: relation A) (RB: relation B) {_: Transitive RA} {_: Transitive RB}: Transitive (sum00_relation RA RB).
Proof.
  hnf; intros.
...
#[export] Instance sum01_transitive {A B: Type} (RA: relation A) (RB: relation B) {_: Transitive RA} {_: Transitive RB}: Transitive (sum01_relation RA RB).
Proof.
  hnf; intros.
  inversion H1; subst; inversion H2; subst;
  constructor;
...
#[export] Instance sum00_preorder {A B: Type} (RA: relation A) (RB: relation B) {_: PreOrder RA} {_: PreOrder RB}: PreOrder (sum00_relation RA RB) :=
  Build_PreOrder _ (sum00_reflexive RA RB) (sum00_transitive RA RB).

#[export] Instance sum01_preorder {A B: Type} (RA: relation A) (RB: relation B) {_: PreOrder RA} {_: PreOrder RB}: PreOrder (sum01_relation RA RB) :=
  Build_PreOrder _ (sum01_reflexive RA RB) (sum01_transitive RA RB).

Definition true_relation (A: Type): relation A := fun _ _ => True.

#[export] Instance true_reflexive (A: Type): Reflexive (true_relation A).
Proof.
  hnf; intros.
  hnf; auto.
Qed.

#[export] Instance true_transitive (A: Type): Transitive (true_relation A).
Proof.
  hnf; intros.
  hnf; auto.
Qed.

#[export] Instance true_preorder (A: Type): PreOrder (true_relation A) :=

...
Section nat_algs.
  ...
  #[export] Instance po_nat_leR: PreOrder (@Krelation _ nat_leR) := Nat.le_preorder.

  #[export] Instance po_nat_geR: PreOrder (@Krelation _ nat_geR).
  Proof.
    constructor.
    + hnf; intros; hnf; lia.
  ...
  (* Increasing*)
  #[export] Instance IndexAlg_increasing:
  ...
  (* Residual*)
  #[export] Instance IndexAlg_residual:
  ...
  (* Unital *)
  #[export] Instance IndexAlg_unital:
  ...
  (* Increasing *)
  #[export] Instance minAlg_increasing:
  ...
  (*Residual*)
  #[export] Instance minAlg_residual:
...
(** *Sum Algebra on NAT*)
  ...
  (*Residual*)
  #[export] Instance sumAlg_residual:
...
Qed.
  ...
  (*it is NOT Residual*)
  #[export] Instance sumpAlg_residual:
...
Qed.
  ...
  (*Residual*)
  #[export] Instance suminvAlg_increasing:
  ...
  (*Residual*)
  #[export] Instance suminvAlg_residual:
  ...
  (* Unital *)
  #[export] Instance suminvAlg_unital:
...
#[export] Instance Heap_Join: Join Heap :=
  @fun_Join _ _ (@option_Join _ (trivial_Join)).

#[export] Instance Heap_SA: SeparationAlgebra Heap :=
  @fun_SA _ _ _ (@option_SA _ _ (trivial_SA)).

(** * Discrete heap *)
#[export] Instance discHeap_R: Relation Heap := eq.
#[export] Instance po_discHeap_R: PreOrder Krelation := eq_preorder _.

#[export] Program Instance discHeap_ikiM: IdentityKripkeIntuitionisticModel Heap.

(*Upwards-closed*)
#[export] Instance discHeap_uSA:
...
(*Unital*)
#[export] Instance discHeap_unital:
...
(*Residual*)
#[export] Instance discHeap_residual:
...
#[export] Instance monHeap_R: Relation Heap :=
  @pointwise_relation _ _ (@option01_relation _ eq).

#[export] Instance po_monHeap_R: PreOrder Krelation :=
  @pointwise_preorder _ _ _ (@option01_preorder _ _ (eq_preorder _)).

(* Upwards-closed*)
#[export] Instance monHeap_uSA:
...
(* Increasing *)
#[export] Instance monHeap_increasing:
...
(* Residual *)
#[export] Instance monHeap_residual:
...
(* Unital *)
#[export] Instance monHeap_unital:
...
(** * Discrete heap *)
#[export] Instance discHeap_R': Relation Heap' :=
  eq.

#[export] Instance po_discHeap_R': PreOrder Krelation :=
  eq_preorder _.
...
Section typed_heaps.
  ...
  #[export] Instance ht_preorder: PreOrder ht_ord.
  Proof.
    constructor;
    hnf; intros.
    - constructor.
  ...
  #[export] Instance THeap_Join': Join THeap' :=
    @fun_Join _ _ (@option_Join _ (trivial_Join)).
...
#[export] Instance THeap_SA': @SeparationAlgebra _ THeap_Join':=
  @fun_SA _ _ _ (@option_SA _ _ (trivial_SA)).
...
#[export] Instance THeap_SA: @SeparationAlgebra THeap THeap_Join.
Proof.
  constructor; intros.
  - inversion H; subst.
...
#[export] Instance THeap_preorder': PreOrder THeap_order'.
constructor.
- hnf; intros.
  constructor; intros.
...
#[export] Instance THeap_R': Relation THeap' := THeap_order'.

#[export] Instance po_THeap_R': PreOrder (@Krelation _ THeap_R').
Proof.
...
(* Increasing *)
#[export] Instance THeap_increasingSA':
...
(*Residual*)
#[export] Instance THeap_residualSA':
...
(*Unital*)
#[export] Instance THeap_UnitalSA':
...
Section step_index.
  ...
  #[export] Instance heap_jn: Join heap:= (Heap_Join addr val).

  #[export] Instance SIheap_Join: Join (nat * heap) := StepIndex_Join heap.
  ...
  (* Increasing *)
  #[export] Instance monSIheap_increasing:
  ...
  (*Unital *)
  #[export] Instance monSIheap_unital:
  ...
  (*Residual *)
  #[export] Instance monSIheap_residual:
  ...
  (*Upwards-closed *)
  #[export] Instance discSIheap_uSA:
  ...
  (*Unital *)
  #[export] Instance discSIheap_unital:
  ...
  (*Residual *)
  #[export] Instance discSIheap_residual:
...
#[export] Instance Prop_Join: Join Prop := fun P Q R => (P \/ Q <-> R) /\ (P -> Q -> False).
  
#[export] Instance discProp_R: Relation Prop := fun P Q => P <-> Q.

#[export] Instance Prop_SA: SeparationAlgebra Prop.
Proof.
  constructor.
  + intros.
    hnf in *; tauto.
...
#[export] Instance po_discProp_R: PreOrder Krelation.
Proof.
  constructor; constructor;
  hnf in *; tauto.
Qed.

#[export] Instance discProp_ikiM: IdentityKripkeIntuitionisticModel Prop.
Proof.
  constructor.
  intros.
  apply prop_ext; auto.
...
#[export] Instance Pred_Join: Join Pred :=
  @fun_Join _ _ Prop_Join.

#[export] Instance Pred_SA: SeparationAlgebra Pred :=
  @fun_SA _ _ _ Prop_SA.

#[export] Instance discPred_R: Relation Pred := pointwise_relation _ discProp_R.
#[export] Instance po_discPred_R: PreOrder Krelation := pointwise_preorder _ _ po_discProp_R.

#[export] Instance discPred_uSA: @UpwardsClosedSeparationAlgebra Pred discPred_R Pred_Join :=
  fun_uSA _ _ discProp_uSA.

#[export] Instance discPred_dSA: @DownwardsClosedSeparationAlgebra Pred discPred_R Pred_Join :=
  fun_dSA _ _ discProp_dSA.

#[export] Instance discPred_unital: @UnitalSeparationAlgebra Pred discPred_R Pred_Join :=
...
(*
(** * Discrete heap *)
#[export] Instance discHeap_kiM: KripkeIntuitionisticModel Heap :=
  identity_kiM.

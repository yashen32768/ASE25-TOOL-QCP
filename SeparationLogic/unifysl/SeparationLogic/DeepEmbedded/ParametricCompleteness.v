...
Existing Instances ParametricSeparationLogic.GP ParametricSeparationLogic.GD ParametricSeparationLogic.GDP ParametricSeparationLogic.minAX ParametricSeparationLogic.andpAX ParametricSeparationLogic.orpAX ParametricSeparationLogic.falsepAX ParametricSeparationLogic.iffpAX ParametricSeparationLogic.truepAX ParametricSeparationLogic.inegpAX ParametricSeparationLogic.sepconAX ParametricSeparationLogic.wandAX ParametricSeparationLogic.empAX ParametricSeparationLogic.sepcon_orp_AX ParametricSeparationLogic.sepcon_falsep_AX ParametricSeparationLogic.ParAX.

Existing Instances Axiomatization2SequentCalculus_GammaPD Axiomatization2SequentCalculus_bSC Axiomatization2SequentCalculus_fwSC Axiomatization2SequentCalculus_minSC Axiomatization2SequentCalculus_andpSC Axiomatization2SequentCalculus_orpSC Axiomatization2SequentCalculus_falsepSC Axiomatization2SequentCalculus_truepSC Axiomatization2SequentCalculus_iffpSC Axiomatization2SequentCalculus_inegpSC Axiomatization2SequentCalculus_cpSC.

Existing Instances FlatSemantics.MD FlatSemantics.kMD FlatSemantics.R FlatSemantics.J FlatSemantics.U FlatSemantics.SM FlatSemantics.kminSM FlatSemantics.andpSM FlatSemantics.orpSM FlatSemantics.falsepSM FlatSemantics.fsepconSM FlatSemantics.fwandSM FlatSemantics.empSM.
...
Definition H_U:
  forall m Phi, rel m Phi -> (is_unit m <-> proj1_sig Phi emp).
Proof.
  intros.
  change (m = Phi) in H.
  subst; reflexivity.
...
Proof.
  ...
  + exact (truth_lemma_emp cP rel H_U AL_DC LIN_CD LIN_SR).
  ...
  strongly_complete (ParametricSeparationLogic.GD SLP) FlatSemantics.SM
    (KripkeModelClass _
      (FlatSemantics.Kmodel_Monotonic +
       ...
       FlatSemantics.Kmodel_UnitJoinOrderRel +
...
Proof.
  ...
  + pose proof (unitSA cP rel H_R H_J H_U AL_DC LIN_SR TRUTH). unfold FlatSemantics.Kmodel_UnitJoinOrderRel. auto.
  + inversion PC.

...
Lemma sound_provable_andp_elim1:
  forall x y: expr,
    forall m,
      KRIPKE: M, m |= x && y --> x.
Proof.
...
Lemma sound_provable_andp_elim2:
  forall x y: expr,
    forall m,
      KRIPKE: M, m |= x && y --> y.
Proof.
...
Lemma sound_provable_orp_intros1:
  forall x y: expr,
    forall m,
      KRIPKE: M, m |= x --> x || y.
Proof.
...
Lemma sound_provable_orp_intros2:
  forall x y: expr,
    forall m,
      KRIPKE: M, m |= y --> x || y.
Proof.
...
Lemma sound_provable_falsep_elim:
  forall x: expr,
    forall m,
      KRIPKE: M, m |= FF --> x.
Proof.
...
Lemma sound_provable_peirce_law_ident {ikiM: IdentityKripkeIntuitionisticModel (Kworlds M)}:
  forall x y: expr,

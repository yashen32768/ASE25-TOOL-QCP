...
Proof.
  ...
  apply derivables_orp_intros1 with (y := y0) in H9.
  apply derivables_orp_intros2 with (x := x0) in H10.
  rewrite derivables_impp_theorem in H9, H10.
  ...
  pose proof derivables_orp_elim' _ _ _ _ H9 H10.
  apply derivable_assum in H2.
  pose proof derivables_modus_ponens _ _ _ H2 H8.
  apply DC; auto.
Qed.
